...
Parameters:
	r0: u16 color // unsigned 16-bit number
Returns: none

Pseudocode:
u32 colorpair = (u16 << 16) | u16;
for (int row = 0; row < 240; ++row) {
	void *buffer = PIX_BUFFER + row << 10;
	for (int col = 0; col < 320 / 2; ++col) { // col doesn't count pixels, but pixel *pairs*
