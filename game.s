...
.EQU ITEMTYPE_VARIANT_HEALTHKIT, 0
.EQU ITEMTYPE_VARIANT_MINERAL, 1
...
fn maybeCollideBulletAsteroid(asteroid: &mut Asteroid, bullet: &mut Bullet) {
	...
	if asteroid.health <= 0 {
		asteroid.lifetime = 0;
		spawnItem(asteroid.xPos, asteroid.yPos);
	}
}
*/
...
fn spawnItem(x: i16, y: i16) {
	...
	item.xVel = 0;
	item.yVel = 0;
	item.itemType = ItemType::UpgradeMaxSpeed;
...
spawnItem:
	...
	// r5 = item.itemType
	mov r5, #ITEMTYPE_VARIANT_UPGRADEMAXSPEED
	strb r5, [r4, #ITEM_FIELD_ITEMTYPE]
